package com.nacho.curso.springboot.jpa.springbootjpa.repositories;
...
import com.nacho.curso.springboot.jpa.springbootjpa.dto.PersonDto;
import com.nacho.curso.springboot.jpa.springbootjpa.entities.Person;
...
public interface PersonRepository extends CrudRepository<Person, Long> {
    ...
    @Query("select new com.nacho.curso.springboot.jpa.springbootjpa.dto.PersonDto(p.name, p.lastname) from Person p")
